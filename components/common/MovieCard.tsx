...
export default function MovieCard({ Poster, onPress, Title, imdbRating, Year, imdbID }: MovieProps) {
  ...
  return (
    ...
    >
      {isValidPoster ? (
        <View style={{ padding: 4, gap: 4 ,borderBottomWidth:1,borderBottomColor:'#ffffff27' ,}}>
          <Image
            source={{ uri: Poster }}
          ...
          />
           ...
           <View style={{ flexDirection: "column", paddingHorizontal: 4, justifyContent: "space-between" }}>
